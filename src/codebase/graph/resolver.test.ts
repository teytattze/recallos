...
describe("resolveSpecifier", () => {
  test("given relative specifier, resolves to .ts file", () => {
  ...
  test("given relative specifier, resolves to .tsx file", () => {
  ...
  test("given relative specifier, resolves to index.ts", () => {
  ...
  test("given alias specifier, maps through alias", () => {
  ...
  test("given external package, returns null", () => {
  ...
  test("given unresolvable relative path, returns null", () => {
    const exists = makeFileExists([]);
    const result = resolveSpecifier(
      "./nonexistent",
      "src/foo.ts",
  ...
  test("given parent directory import, resolves correctly", () => {
